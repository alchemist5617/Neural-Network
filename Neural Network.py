...
mean_active= train_x[active_index,:].mean(0)
mean_inactive= train_x[~active_index,:].mean(0)
diff=abs(mean_active-mean_inactive)

feature_treshold = 0.003
index = np.array((diff>feature_treshold))[0]
...
print("Training the Neural Network in 30 epochs:\n")
